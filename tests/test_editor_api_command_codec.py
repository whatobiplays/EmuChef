    ...
    def test_invalid_command_type_and_payload_raise_controlled_api_error(self) -> None:
        invalid_payloads = [
            ...
            },
            {
                "type": "UpdateStepConstraints",
                "stepId": "copy_cores",
                "constraints": {"capabilities": [], "conflicts_with": ["stop_app"]},
            },
            {
                "type": "UpdateStepConstraints",
                "stepId": "copy_cores",
                "constraints": {"capabilities": [], "conflictsWith": [], "custom": True},
            },
            ...
            {"type": "UpdateStepSkipIf", "stepId": "copy_cores", "skipIf": [{"type": "path_exists", "params": []}]},
            {
                "type": "UpdateStepSkipIf",
                "stepId": "copy_cores",
                "skipIf": [{"type": "path_exists", "params": {}, "custom": True}],
            },
            ...
            {"type": "UpdateStepVerify", "stepId": "copy_cores", "verify": [{"type": "path_exists", "params": []}]},
            {
                "type": "UpdateStepVerify",
                "stepId": "copy_cores",
                "verify": [{"type": "path_exists", "params": {}, "custom": True}],
            },
            {"inputId": "roms_dir"},
            "AddInput",
        ]
