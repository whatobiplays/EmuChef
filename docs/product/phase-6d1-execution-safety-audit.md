...
2. Qualify the same-serial identity evidence on representative physical devices
   ...
   separately approved.
3. Design repeated root-authority revalidation and define its abort policy.
...
typecheck, lint, build, and diff commands. Phase 6D.2, Phase 6D.3, and Phase
6D.4 use deterministic host tests and do not claim new physical-device,
